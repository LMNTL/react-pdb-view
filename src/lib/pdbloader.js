...
import { BufferGeometry } from 'three-full/sources/core/BufferGeometry.js'
import { Float32BufferAttribute } from 'three-full/sources/core/BufferAttribute.js'
import { DefaultLoadingManager } from 'three-full/sources/loaders/LoadingManager.js'
...
PDBLoader.prototype = {
    ...
    for (var i = 0, l = lines.length; i < l; i++) {
      ...
      if (line.substr(0, 5) === 'HELIX') {
        // Parse HELIX record
        var helix = {
          id: trim(line.substr(11, 3)),
          startChain: line.substr(19, 1),
          startRes: parseInt(line.substr(21, 4)),
          endChain: line.substr(31, 1),
          endRes: parseInt(line.substr(33, 4))
        };
        helices.push(helix);
        ...
        var sheet = {
          ...
          startRes: parseInt(line.substr(22, 4)),
